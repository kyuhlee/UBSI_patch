#!/bin/bash
mkdir /home/vagrant/TRACE
mkdir /home/vagrant/TRACE/BIN
...
./configure -with-mpm=worker && make 
sudo make install
cp /usr/local/apache2/bin/httpd /home/vagrant/TRACE/BIN
cp /home/vagrant/UBSI_patch/httpd.conf /usr/local/apache2/conf/httpd.conf
...
./configure && make
cp src/vim /home/vagrant/TRACE/BIN
#executable - src/vim
...
cp /usr/local/sbin/proftpd /home/vagrant/TRACE/BIN
...
./configure && make
cp src/wget /home/vagrant/TRACE/BIN
...
cp ./pine/pine /home/vagrant/TRACE/BIN
...
cp /usr/local/sbin/cherokee /home/vagrant/TRACE/BIN
cp /usr/local/sbin/cherokee-worker /home/vagrant/TRACE/BIN
...
./configure && make
cp src/yafc /home/vagrant/TRACE/BIN
...
./configure && make
cp ./daemon/transmission-daemon /home/vagrant/TRACE/BIN
cp ./cli/transmission-cli /home/vagrant/TRACE/BIN
...
# ./configure && make
# cp ./bash /home/vagrant/TRACE/BIN
...
./configure && make
cp ./src/mc /home/vagrant/TRACE/BIN
...
sudo make install
# config -  /usr/local/etc/sshd_config
cp /usr/local/sbin/sshd /home/vagrant/TRACE/BIN
cp /usr/local/bin/ssh /home/vagrant/TRACE/BIN
...
sudo mkdir -p /usr/man/man8 /usr/man/man1 /usr/man/man5 
sudo ./Build install
cp /usr/sbin/sendmail /home/vagrant/TRACE/BIN
